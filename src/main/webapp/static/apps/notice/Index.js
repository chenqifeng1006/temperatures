define([
    'BasePage',
    'Util',
    'text!../../template/notice/newTpl1.html',	
...
function (BasePage,Util,newTpl1,newTpl2,newTpl3,newTpl4,newTpl5,newTpl6,messageTpl) {
    return BasePage.extend({
        ...
        _bindEvent:function(){
        	...
        	$('#submit').click(function(){
        		var content = $('#contentText').text() || $('#contentText').val();
        	if(!content){
        		that.alert('评论不可为空')
        		return false;
        	}
